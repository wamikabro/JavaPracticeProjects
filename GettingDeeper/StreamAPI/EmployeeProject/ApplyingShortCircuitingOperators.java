...
public class ApplyingShortCircuitingOperators {
    public static void main(String[] args) {
        ...
        List<Employee>  shortCircuit = employees
                ...
                .limit(1) // just take the 1 element
                .collect(Collectors.toList()); // collect the element into the list

        // it will print the 2nd element only
